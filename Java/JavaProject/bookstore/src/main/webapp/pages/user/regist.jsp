...
//4 提示用户
	...
	<script type="text/javascript">
		$(function () {
            $("#username").blur(function () { //用户名输入框失去焦点事件
                $.getJSON("http://localhost:8080/bookstore/user", "action=ajaxExistUsername&username="+this.value, function (data) { //data为回传数据
                    if (!data.exist) {
						...
						<div class="login_box">
							...
							<div class="form">
								<form action="user " method="post">
									...
									<img id="code_img" alt="" src="kaptcha.jpg" style="float: right; margin-right: 40px;width: 100px;height: 50px">
									<script type="text/javascript">
										<%--更换验证码--%>
										$(function () {
